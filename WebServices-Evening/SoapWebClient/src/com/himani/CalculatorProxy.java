...
public class CalculatorProxy implements com.himani.Calculator {
  private String _endpoint = null;
  private com.himani.Calculator calculator = null;
  ...
  private void _initCalculatorProxy() {
    try {
      calculator = (new com.himani.CalculatorServiceLocator()).getCalculator();
      if (calculator != null) {
        if (_endpoint != null)
  ...
  public com.himani.Calculator getCalculator() {
    if (calculator == null)
      _initCalculatorProxy();
    return calculator;
  }
