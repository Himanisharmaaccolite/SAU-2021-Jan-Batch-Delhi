...
<jsp:useBean id="sampleCalculatorProxyid" scope="session" class="com.himani.CalculatorProxy" />
<%
...
case 10:
        gotMethod = true;
        com.himani.Calculator getCalculator10mtemp = sampleCalculatorProxyid.getCalculator();
...
case 34:
        ...
        double subtract34mtemp = sampleCalculatorProxyid.subtract(a_7idTemp,b_8idTemp);
        String tempResultreturnp35 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(subtract34mtemp));
        %>
        <%= tempResultreturnp35 %>
        <%
break;
