...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.himani.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/SoapWeb/services/Calculator";
    ...
    public com.himani.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.himani.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.himani.CalculatorSoapBindingStub _stub = new com.himani.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.himani.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.himani.CalculatorSoapBindingStub _stub = new com.himani.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://himani.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://himani.com", "Calculator"));
        }
